    ...
    >
      ...
      >
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
          ...
          >
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
              <circle cx="10" cy="3" r="2" stroke="#fff" strokeWidth="1.3" />
              <circle cx="10" cy="10" r="2" stroke="#fff" strokeWidth="1.3" />
              <circle cx="3" cy="6.5" r="2" stroke="#fff" strokeWidth="1.3" />
              <path
                d="M5 7.5l3.5 2M8.5 4L5 5.5"
                stroke="#fff"
                strokeWidth="1.2"
                strokeLinecap="round"
              />
      ...
      <div style={{ maxWidth: 940, margin: "0 auto", padding: "2.5rem 2rem" }}>
          ...
          <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
            ...
            <div>
              ...
              >
                ...
                Generated {displayGenerated} · Period:{" "}
                <strong
                  style={{
                    color: "var(--color-text-primary)",
                    fontWeight: 500,
        ...
        >
          ...
          >
            ...
            >
              {isTask ? "Task breakdown" : "Class breakdown"}
            </p>
            <span
              style={{
                fontSize: 12,
            ...
            >
              {data.rows.length} {isTask ? "tasks" : "classes"}
            </span>
          </div>
          <table
